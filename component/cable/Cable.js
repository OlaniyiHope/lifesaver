...
<View style={styles.container}>
   <View style={styles.top}>
       <Text style={styles.questions}>CableTV</Text>
   ...
   <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate("Elect")}>
   ...
   <FontAwesome5 onPress={()=>navigation.navigate("Elect")} name="user-clock" size={24} color="black" />
