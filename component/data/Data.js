...
<View style={styles.container}>
   <View style={styles.top}>
       <Text style={styles.questions}>Data</Text>
   ...
   <TextInput style = {styles.input}
               placeholder = "*********"/>
    <Text style={styles.question}>Data plan</Text>
   <TextInput style = {styles.input}
               placeholder = "*********"/>
   ...
   <FontAwesome5 onPress={()=>navigation.navigate("Cable")} name="user-clock" size={24} color="black" />
