...
<View style={styles.container}>
   <View style={styles.top}>
       <Text style={styles.questions}> Debit Card</Text>
   </View>
   <View>
   ...
   <View style={styles.bottom}>
   <TouchableOpacity style={styles.button2} onPress={()=>navigation.navigate("AddCard")}>
       <Text style={styles.buttonText2}>Delete card</Text>
    </TouchableOpacity>
