...
<View style={styles.container}>
   <View style={styles.top}>
       <Text style={styles.questions}>Electricity</Text>
   ...
   <TextInput style = {styles.input}
               placeholder = "IBEDC"/>
    <Text style={styles.question}>Customer ID</Text>
   <TextInput style = {styles.input}
               placeholder = "*********"/>
    <Text style={styles.question}>Service</Text>
   <TextInput style = {styles.input}
               placeholder = "*********"/>
   ...
   <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate("Inter")}>
   ...
   <FontAwesome5 onPress={()=>navigation.navigate("Inter")} name="user-clock" size={24} color="black" />
