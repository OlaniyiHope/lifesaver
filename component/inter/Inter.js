...
<View style={styles.container}>
   <View style={styles.top}>
       <Text style={styles.questions}>INternet</Text>
   ...
   <TextInput style = {styles.input}
               placeholder = "*********"/>
    <Text style={styles.question}>Serivice</Text>
   <TextInput style = {styles.input}
               placeholder = "*********"/>
   ...
   <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate("Fund")}>
