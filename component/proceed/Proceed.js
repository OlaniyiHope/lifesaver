...
<View style={styles.container}>
   <View style={styles.top}>
       <Text style={styles.questions}>Tanjiri98</Text>
       <Text style={styles.question3}>Enter your password to proceed</Text>
   </View>
...
<Text style={styles.question6}>Forgot password</Text>
   <View style={styles.bottom}>
   <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate("Uh")}>
   ...
   <Text style={styles.question3}>I am not Tanjiri98</Text>
