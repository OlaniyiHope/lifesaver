...
<View style={styles.container}>
   ...
   <View style={styles.top}>
       <Text style={styles.questions}>Fixed safe</Text>
...
<Text>N600.00</Text>
   ...
   <FontAwesome5 onPress={()=>navigation.navigate("Kick")} name="user-clock" size={18} color="black" />
